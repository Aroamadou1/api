...
class CreateInventaireMaisonProduitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventaire_maison_produits', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('inventaire_maison_produits');
    }
}
